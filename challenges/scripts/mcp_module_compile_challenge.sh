#!/usr/bin/env bash
# mcp_module_compile_challenge.sh - Validates MCP Module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.mcp"
if grep -q "^module digital.vasic.mcp$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.mcp"
else
