# MCP_Module - Generic, reusable Go module implementing the Model Context Protocol (MCP) for AI tool integration.
# Module: digital.vasic.mcp_module
...
challenge:
	../challenges/scripts/mcp_module_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "MCP_Module - Generic, reusable Go module implementing the Model Context Protocol (MCP) for AI tool integration."
	@echo ""
	@echo "Build & Test:"
